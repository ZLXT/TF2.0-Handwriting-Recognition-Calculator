...
class PaintBoard(QWidget):
    ...
    def mouseMoveEvent(self, mouseEvent):
        ...
        if self.EraserMode == False:
            #非橡皮擦模式
            self.__painter.setPen(QPen(Qt.red,6,Qt.SolidLine,Qt.RoundCap,Qt.RoundJoin)) #设置画笔颜色，粗细
        else:
            #橡皮擦模式下画笔为纯白色
            self.__painter.setPen(QPen(Qt.white,self.__eraser,Qt.SolidLine,Qt.RoundCap,Qt.RoundJoin))
